      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">{t("landing.footerCompanyFull")}</p>
          ...
          <div className="flex flex-col gap-2">
            <h4 className="text-sm font-semibold text-white mb-1">{t("landing.footerQuickLinks")}</h4>
            <Link href="/" className="text-xs text-slate-400 hover:text-white transition-colors">Trang chủ</Link>
            <Link href="/shop" className="text-xs text-slate-400 hover:text-white transition-colors">Shop</Link>
            <Link href="/tracking" className="text-xs text-slate-400 hover:text-white transition-colors">Tra cứu đơn hàng</Link>
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">{t("landing.headOfficeAddr")}</p>
            <div className="mt-2">

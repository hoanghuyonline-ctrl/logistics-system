...
const publicPaths = ["/", "/login", "/register", "/shop", "/api/auth", "/api/health", "/api/public/products", "/api/telegram/webhook", "/api/messenger/webhook", "/api/zalo/webhook", "/api/tracking", "/api/webhooks/bank-transfer", "/api/leads/capture"];

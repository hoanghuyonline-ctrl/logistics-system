...
export async function GET(request: Request) {
  ...
  const limit = parseInt(searchParams.get("limit") || "100", 10); // Default to 100 for enterprise deep cào limit
  ...
  // 3. NO-CACHE DEEP CRAWL - Generate larger product library (300 products) for infinite pagination

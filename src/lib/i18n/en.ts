const en: Record<string, string> = {
  ...
  // Chatbot config
  "nav.chatbotConfig": "Chatbot config",
  "chatbot.title": "Chatbot quality controls",
  "chatbot.subtitle": "Adjust chatbot auto-reply behavior",
  "chatbot.conciseReplies": "Concise replies",
  "chatbot.conciseDesc": "Send only the first paragraph of the answer",
  "chatbot.avoidRepeat": "Avoid repeated answers",
  "chatbot.avoidRepeatDesc": "Flag when same sender asks same question within 5 min",
  "chatbot.fallbackHuman": "Fallback to human support",
  "chatbot.fallbackHumanDesc": "Log when chatbot cannot find an answer",
  "chatbot.allowedTopics": "Allowed topics",
  "chatbot.allowedTopicsDesc": "Comma-separated topic list (empty = all topics)",
  "chatbot.allowedTopicsPlaceholder": "e.g. shipping fees, top-up, warehouse",
  "chatbot.minMatchScore": "Min match score",
  "chatbot.minMatchScoreDesc": "Answers below this score will not be sent",
  "chatbot.saved": "Chatbot config saved",
  "chatbot.saveError": "Failed to save config",
  "chatbot.qualityTitle": "Quality log (24h)",
  "chatbot.lowScore": "Low score",
  "chatbot.repeated": "Repeated",
  "chatbot.fallback": "Human fallback",
  "chatbot.topicBlocked": "Topic blocked",
  "chatbot.conciseApplied": "Concise",
  "chatbot.recentLogs": "Recent logs",
  "chatbot.noLogs": "No quality logs yet",

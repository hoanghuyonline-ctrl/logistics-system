const vi: Record<string, string> = {
  ...
  // Chatbot config
  "nav.chatbotConfig": "Cấu hình chatbot",
  "chatbot.title": "Cấu hình chất lượng chatbot",
  "chatbot.subtitle": "Điều chỉnh hành vi trả lời tự động của chatbot",
  "chatbot.conciseReplies": "Trả lời ngắn gọn",
  "chatbot.conciseDesc": "Chỉ gửi đoạn đầu tiên của câu trả lời",
  "chatbot.avoidRepeat": "Tránh trả lời trùng lặp",
  "chatbot.avoidRepeatDesc": "Đánh dấu khi cùng người hỏi cùng câu trong 5 phút",
  "chatbot.fallbackHuman": "Chuyển sang hỗ trợ nhân viên",
  "chatbot.fallbackHumanDesc": "Ghi log khi chatbot không tìm được câu trả lời",
  "chatbot.allowedTopics": "Chủ đề cho phép",
  "chatbot.allowedTopicsDesc": "Danh sách chủ đề phân cách bằng dấu phẩy (để trống = tất cả)",
  "chatbot.allowedTopicsPlaceholder": "VD: phí vận chuyển, nạp tiền, kho hàng",
  "chatbot.minMatchScore": "Điểm khớp tối thiểu",
  "chatbot.minMatchScoreDesc": "Câu trả lời có điểm thấp hơn sẽ không được gửi",
  "chatbot.saved": "Đã lưu cấu hình chatbot",
  "chatbot.saveError": "Không thể lưu cấu hình",
  "chatbot.qualityTitle": "Nhật ký chất lượng (24h)",
  "chatbot.lowScore": "Điểm thấp",
  "chatbot.repeated": "Trùng lặp",
  "chatbot.fallback": "Chuyển nhân viên",
  "chatbot.topicBlocked": "Chủ đề bị chặn",
  "chatbot.conciseApplied": "Rút gọn",
  "chatbot.recentLogs": "Nhật ký gần đây",
  "chatbot.noLogs": "Chưa có nhật ký chất lượng",
  "chatbot.channel": "Kênh",
  "chatbot.question": "Câu hỏi",
  "chatbot.flag": "Loại",
  "chatbot.score": "Điểm",
